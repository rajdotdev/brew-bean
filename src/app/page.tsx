    ...
    <section className="relative min-h-screen flex items-center pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
        <div className="reveal">
          <p className="text-sm tracking-[0.3em] uppercase text-[#a67040] mb-6">
            Est. 2014 - Slow-Brewed
          </p>
          <h1 className="serif text-5xl md:text-6xl lg:text-7xl xl:text-8xl leading-[0.95] font-medium mb-8 text-[#2d1f1a]">
            Where every<br />
            <em className="text-[#a67040]">cup</em> tells<br />
            a story.
          </h1>
          <p className="text-lg text-[#6b5b4f] max-w-md mb-10 leading-relaxed">
        ...
        <div className="relative reveal">
          ...
          <div className="absolute -bottom-6 -left-6 md:-left-12 bg-[#faf6f0] rounded-full w-28 h-28 md:w-40 md:h-40 flex flex-col items-center justify-center shadow-xl border border-[#3b2a20]/10">
            <span className="serif text-3xl md:text-4xl text-[#a67040]">10+</span>
        ...
        <div className="marquee-track serif text-2xl md:text-3xl italic">
          {items.map((item, i) => (
            <span key={i} className="mx-4">
              {item}
              <span className="mx-6 text-[#a67040]">*</span>
            </span>
          ))}
          {items.map((item, i) => (
  ...
  return (
    <section className="py-20 md:py-28 bg-[#3b2a20] text-[#f6f1ea] relative overflow-hidden">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-12 text-center relative z-10 reveal">
        ...
        <p className="text-[#6b5b4f] max-w-xl mx-auto mb-10 leading-relaxed">
          Reserve a table for the weekend, or just walk in - well save you the seat by the window.
        </p>
        <Link
          href="/visit"
          className="inline-block bg-[#f6f1ea] text-[#2d1f1a] px-10 py-4 rounded-full text-sm tracking-wide hover:bg-[#b08456] hover:text-[#f6f1ea] transition-all duration-300 hover:-translate-y-1"
        >
          Reserve a Table
        </Link>
      </div>
...
function Footer() {
  return (
    <footer className="bg-[#1f1612] text-[#f6f1ea] py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex gap-6 text-sm">
          <a href="#" className="hover:text-[#a67040] transition">
            Instagram
          </a>
          <a href="#" className="hover:text-[#a67040] transition">
            Twitter
